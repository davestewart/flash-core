	...
	public class MediaEvent extends Event 
	{
		...
		// constants
			...
			// playing or recording	
				...
				public static const UPDATED					:String		= 'MediaEvent.UPDATED';					// Dispatched every 0.25 seconds by default while the media is playing. You can specify frequency with the playheadUpdateInterval property
